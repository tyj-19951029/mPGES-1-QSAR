...
class gridSearchPlus(gridSearchBase):
    ...
    def __SelectEstimator(self):
        ...
        if self.__grid_estimatorName[-1] == 'R':
            ...
            #添加，未测试    
            if self.__grid_estimatorName == 'XGBR':
                self.grid_dict = {
                ...
                self.grid_estimator = xgb.XGBRegressor(eval_metric='rmse',seed=self.random_state,objective='reg:squarederror')            
